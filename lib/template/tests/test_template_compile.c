...
test_simple_macro(void)
{
  ...
  assert_compiled_template(text = (char *)"", default_value = NULL, macro = M_MESSAGE, type = LTE_MACRO, msg_ref = 0);
}
...
test_macro_and_text(void)
{
  ...
  select_next_element();
  assert_compiled_template(text = (char *)"test value", default_value = NULL, macro = M_NONE, type = LTE_MACRO, msg_ref = 0);
}
...
test_macro_with_at_references_a_single_msg_in_the_context_stack_by_setting_msgref(void)
{
  ...
  assert_compiled_template(text = (char *)"", default_value = NULL, macro = M_MESSAGE, type = LTE_MACRO, msg_ref = 1);

  assert_template_compile("${MESSAGE}@1");
  assert_compiled_template(text = (char *)"", default_value = NULL, macro = M_MESSAGE, type = LTE_MACRO, msg_ref = 2);
...
test_macro_with_invalid_msgref_are_recognized_as_the_top_element_in_the_stack(void)
{
  ...
  select_next_element();
  assert_compiled_template(text = (char *)"@gmail.com", default_value = NULL, macro = M_NONE, type = LTE_MACRO, msg_ref = 0);
}
...
test_dollar_prefixed_with_backslash_is_a_literal_dollar(void)
{
  ...
  assert_compiled_template(text = (char *)"Test $STRING", default_value = NULL, macro = M_NONE, type = LTE_MACRO, msg_ref = 0);

  cfg_set_version(configuration, 0x305);
  assert_template_compile("Test \\$STRING");
  assert_compiled_template(text = (char *)"Test \\", default_value = NULL, value_handle = log_msg_get_value_handle("STRING"), type = LTE_VALUE, msg_ref = 0);
}
...
test_colon_dash_in_braces_is_parsed_as_default_value(void)
{
  ...
  assert_compiled_template(text = (char *)"", default_value = (char *)"default value", macro = M_MESSAGE, type = LTE_MACRO, msg_ref = 0);

  assert_template_compile("${MESSAGE:-}");
  assert_compiled_template(text = (char *)"", default_value = (char *)"", macro = M_MESSAGE, type = LTE_MACRO, msg_ref = 0);
}
...
test_dollar_with_an_invalid_macro_name_without_braces_is_parsed_as_a_literal_dollar(void)
{
  ...
  assert_compiled_template(text = (char *)"$", default_value = NULL, macro = M_NONE, type = LTE_MACRO, msg_ref = 0);
...
test_backslash_without_finishing_the_escape_sequence_is_ignored(void)
{
  ...
  assert_compiled_template(text = (char *)"foo", default_value = NULL, macro = M_NONE, type = LTE_MACRO, msg_ref = 0);
...
test_double_at_is_a_literal_at(void)
{
  ...
  select_next_element();
  assert_compiled_template(text = (char *)"@12", default_value = NULL, macro = M_NONE, type = LTE_MACRO, msg_ref = 0);
}
...
{
  assert_template_compile("${VALUE_NAME}");
  assert_compiled_template(text = (char *)"", default_value = NULL, value_handle = log_msg_get_value_handle("VALUE_NAME"), type = LTE_VALUE, msg_ref = 0);
}
...
test_backslash_within_braces_is_taken_literally(void)
{
  ...
  assert_compiled_template(text = (char *)"", default_value = NULL, value_handle = log_msg_get_value_handle("VALUE\\"), type = LTE_VALUE, msg_ref = 0);
}
...
{
  assert_template_compile("${}");
  assert_compiled_template(text = (char *)"", default_value = NULL, value_handle = log_msg_get_value_handle(""), type = LTE_VALUE, msg_ref = 0);
}
...
test_simple_template_function(void)
{
  ...
  assert_compiled_template(text = (char *)"", default_value = NULL, func.ops = get_template_function_ops("hello"), type = LTE_FUNC, msg_ref = 0);
}
...
test_complicated_template_function(void)
{
  ...
  assert_compiled_template(text = (char *)"", default_value = NULL, func.ops = get_template_function_ops("hello"), type = LTE_FUNC, msg_ref = 3);
}
...
test_invalid_macro(void)
{
  ...
  assert_compiled_template(text = (char *)"error in template: ${MESSAGE", default_value = NULL, macro = M_NONE, type = LTE_MACRO, msg_ref = 0);
}
...
test_invalid_subst(void)
{
  ...
  assert_compiled_template(text = (char *)"error in template: ${MESSAGE:1}", default_value = NULL, macro = M_NONE, type = LTE_MACRO, msg_ref = 0);
}
...
test_template_function_bad1(void)
{
  ...
  assert_compiled_template(text = (char *)"error in template: $( hello \\tes\t\t\t value(xyz \"value with spaces\" 'test value with spa\"ces')", default_value = NULL, macro = M_NONE, type = LTE_MACRO, msg_ref = 0);
}
...
test_template_function_bad3(void)
{
  ...
  assert_compiled_template(text = (char *)"error in template: $(hello \"This is an unclosed quoted string)", default_value = NULL, macro = M_NONE, type = LTE_MACRO, msg_ref = 0);
}
...
test_unknown_function(void)
{
  ...
  assert_compiled_template(text = (char *)"error in template: $(unknown function)", default_value = NULL, macro = M_NONE, type = LTE_MACRO, msg_ref = 0);
}
