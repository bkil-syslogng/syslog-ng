...
static gboolean
log_rewrite_groupset_foreach_func(const gchar *name, TypeHint type,const GString *value, gpointer user_data)
{
  ...
  log_template_format(template, msg, NULL, LTZ_LOCAL, 0, value->str, result);
