...
static gboolean
__log_msg_serialize(LogMessage *self, SerializeArchive *sa)
{
  guint8 version = 26;
  gint i = 0;
...
static gboolean
__log_msg_deserialize(LogMessage *self, SerializeArchive *sa)
{
...
static gboolean
__deserialize(LogMsgSerializer *self, LogMessage *msg, SerializeArchive *sa)
{
  return __log_msg_deserialize(msg, sa);
}

static gboolean
__serialize(LogMsgSerializer *self, LogMessage *msg, SerializeArchive *sa)
{
  return __log_msg_serialize(msg, sa);
}
...
__constructor()
{
  ...
  self->super.log_msg_deserialize = __deserialize;
  self->super.log_msg_serialize = __serialize;
